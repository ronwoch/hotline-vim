...
let g:colors_name = 'lampaces-dmon'
set background=dark
"}}}
" GUI & Term Palettes "{{{
" ----------------------------------------------------------------------
let s:base00 = ['#002b36', '234']
let s:base01 = ['#ff0089', '198']
let s:base02 = ['#d7ff00', '190']
let s:base03 = ['#ff0087', '198']
...
call <SID>X('Comment',        s:base00, s:base16,       '')
...
call <SID>X('VertSplit',      s:base16, s:base00, '')
